...
import dev.withcapsule.android.ui.screens.OnboardingScreen
import dev.withcapsule.android.ui.screens.QRScannerScreen
import dev.withcapsule.android.ui.screens.ScannerTarget
import dev.withcapsule.android.ui.screens.SettingsScreen
import dev.withcapsule.android.ui.screens.UploadScreen
import dev.withcapsule.android.ui.theme.CapsuleTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            // Attach device attributes to the session (once per launch) so each session shows which
            // device/OS it ran on, then record the launch event itself.
            analytics.identify(analytics.deviceInfo)
